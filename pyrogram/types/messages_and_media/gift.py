...
class Gift(Object):
    ...
    def __init__(
        ...
        *,
        ...
        background: types.GiftBackground | None = None,
    ...
    async def _parse_received(
        ...
        parsed_gift.sender = (
            types.Chat._parse_chat(client, users.get(raw_from_id) or chats.get(raw_from_id))
    ...
    async def _parse_action(
        ...
        if isinstance(action_gift, raw.types.MessageActionStarGift):
            ...
            parsed_gift.text = (
                types.FormattedText._parse(client, action_gift.message) or parsed_gift.text
            )
            ...
            parsed_gift.sender = (
                types.Chat._parse_chat(client, users.get(raw_sender_id) or chats.get(raw_sender_id))
                or parsed_gift.sender
            )
