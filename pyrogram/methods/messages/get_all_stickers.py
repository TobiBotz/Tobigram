...
class GetAllStickers:
    async def get_all_stickers(
        ...
        Returns:
            :obj:`~pyrogram.raw.base.messages.AllStickers`: The sticker sets object.

        Example:
            .. code-block:: python

                stickers = await app.get_all_stickers()
        """
        return await self.invoke(raw.functions.messages.GetAllStickers(hash=hash))
