                            ...
                            raw.functions.messages.UploadMedia(
                                ...
                                media=raw.types.InputMediaUploadedDocument(
                                    ...
                                    thumb=await self.save_file(
                                        i.thumb, progress=progress, progress_args=progress_args
                                    ),
                                    spoiler=i.has_spoiler,
                            ...
                            raw.functions.messages.UploadMedia(
                                ...
                                media=raw.types.InputMediaUploadedDocument(
                                    ...
                                    attributes=[
                                        ...
                                        raw.types.DocumentAttributeFilename(
                                            file_name=utils.get_file_name(
                                                i.media, file_name=i.file_name, fallback="audio.mp3"
                                            )
                                        ),
                                    ],
                                ),
                        ...
                        media = await self.invoke(
                            raw.functions.messages.UploadMedia(
                                ...
                                media=raw.types.InputMediaUploadedDocument(
                                    ...
                                    force_file=True
                                    if i.disable_content_type_detection is None
                                    else i.disable_content_type_detection,
                                    attributes=[
                                        raw.types.DocumentAttributeFilename(
                                            file_name=utils.get_file_name(
                                                i.media, file_name=i.file_name, fallback="file.zip"
                                            )
                                        )
                                    ],
                                ),
