        ...
        *,
        ...
        Parameters:
            sticker (``str`` | :obj:`~pyrogram.types.Sticker` | :obj:`~pyrogram.raw.base.InputDocument`):
                The sticker to update. Pass a file_id as string, a :obj:`~pyrogram.types.Sticker` object,
            ...
            keywords (``str``, *optional*):
                If set, updates the sticker search keywords (separated by commas).
        ...
        Example:
            .. code-block:: python
                ...
                # Update sticker emoji and keywords
                await app.change_sticker(
