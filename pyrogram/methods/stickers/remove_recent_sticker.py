...
class RemoveRecentSticker:
    async def remove_recent_sticker(
        ...
        """Remove a sticker from recent stickers.
        ...
        Parameters:
            ...
            attached (``bool``, *optional*):
                Pass True to remove an attached sticker.
        ...
        Example:
            .. code-block:: python
                ...
                await app.remove_recent_sticker(sticker)
        """
        ...
        return await self.invoke(
            raw.functions.messages.SaveRecentSticker(id=doc, unsave=True, attached=attached)
        )
