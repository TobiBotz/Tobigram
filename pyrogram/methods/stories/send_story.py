...
class SendStory:
    async def send_story(
        ...
        try:
                ...
                if allowed_users:
                    for user in allowed_users:
                        ...
                        if isinstance(
                            ...
                            _allowed_users.append(utils.get_input_user(peer))
                        elif isinstance(
                            peer,
                            (
            ...
            while True:
                try:
                    fwd_from_peer = await self.resolve_peer(fwd_from_id) if fwd_from_id else None
                    music_doc = None
                    if music:
