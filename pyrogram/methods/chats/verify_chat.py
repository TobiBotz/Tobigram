...
class VerifyChat:
    async def verify_chat(
        ...
        """Verify a chat on behalf of the organization represented by the bot.
        ...
        Parameters:
            ...
            custom_description (``str``, *optional*):
                Custom description for the verification badge shown on the chat's info page.
        ...
        Example:
            .. code-block:: python
                ...
                # Verify a chat with default description
                await app.verify_chat(chat_id)

                # Verify a chat with a custom badge description
                await app.verify_chat(chat_id, custom_description="Official community")
        """
