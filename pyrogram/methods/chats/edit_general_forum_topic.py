...
class EditGeneralForumTopic:
    async def edit_general_forum_topic(
        self: pyrogram.Client, chat_id: int | str, name: str
    ) -> bool:
        ...
        Example:
            .. code-block:: python
                ...
                await app.edit_general_forum_topic(chat_id, "Main Chat")
        """
        await self.invoke(
            raw.functions.messages.EditForumTopic(
                peer=await self.resolve_peer(chat_id), topic_id=1, title=name
            )
        )
