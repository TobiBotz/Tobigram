...
class AssignAppStoreTransaction:
    async def assign_app_store_transaction(
        ...
        """Assign and verify an Apple App Store receipt to a payment purpose.

        .. include:: /_includes/usable-by/users.rst

        Parameters:
            receipt (``bytes``):
                The App Store transaction receipt data.
        ...
        Example:
            .. code-block:: python
                ...
                await app.assign_app_store_transaction(receipt_bytes, purpose)
        """
        return await self.invoke(
            raw.functions.payments.AssignAppStoreTransaction(
                receipt=receipt,
                purpose=purpose,
            )
        )
