#  Vendored from https://github.com/PaulSonOfLars/telegram-bot-api-spec
#  Copyright (c) 2020 Paul Larsen, MIT licence.
#
#  Kept byte-identical to upstream below this header so a re-sync is a plain
#  diff. refresh.py imports retrieve_info and the two verifiers from here and
#  never calls main(), which writes api.json into the working directory.
